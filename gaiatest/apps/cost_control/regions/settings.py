...
class Settings(Base):
    ...
    def select_when_use_is_above_unit_and_value(self, unit, value):
        ...
        self.wait_for_condition(
            lambda m: self.marionette.find_element(*self._when_use_is_above_button_locator).get_attribute('disabled') == 'false'
        )
        ...
        if current_unit.text is not unit:
            ...
            self.wait_for_condition(lambda m: self.marionette.find_element(*self._unit_button_locator).text == unit)
